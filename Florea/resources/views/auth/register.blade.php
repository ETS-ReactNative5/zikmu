...
<div class="container">
    ...
    <form method="POST" action="{{ route('register') }}">
        ...
        <div>
            ...
            <x-input id="name" class="form-control block mt-1 w-full" type="text" name="name" :value="old('name')" required
                autofocus />
        </div>
        ...
        <div class="mt-4">
            ...
            <x-input id="password_confirmation" class="form-control block mt-1 w-full" type="password" name="password_confirmation"
                required />
        </div>
